  ...
  return (
    <article className="prose">
      ...
      <p>
        ...
        are caught because the system is built to catch them. Distrust thrives on distance —
        the closer you look at how elections actually work, the more reasons you find to
        participate.
      </p>
      <h2>What we believe</h2>
      <p>
        This project is nonpartisan, free, and private by design. We don&apos;t care who you
        vote for. We care that you know who represents you, when your next election is, and
