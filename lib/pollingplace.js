...
//
// VERIFICATION, checked by request on 21 September 2026:
//   Reached, real page (28): AK CA CO CT DE GA HI ID IN IA LA ME MA MT NV NJ NC
//                            ND OR PA SC SD TX UT VT VA WA WV
//   Bot-blocked (403), so unverified from a script (16):
//                            AZ DC FL IL KY MI MN MS MO NH NM NY OH OK RI WI
//                            (MN answered 200, but with a bot-challenge page.)
//   No connection from the check machine (6): AL AR KS MD NE TN
//   Redirected, destination not confirmed (1): WY
// Unverified does not mean wrong. It means the same thing it means for NCSL and
// vote.gov in CLAUDE.md: only a browser can confirm it.
//
