...
const GENERAL_2026_DATE = '2026-11-03';
...
export function getVotingWindow(state, stateFullName, electionDate) {
  ...
  // This data describes the 2026 general only. Once that has passed the next
  // election on the list is 2028, and these dates must not be shown for it.
  if (electionDate !== GENERAL_2026_DATE) return null;
  if (parse(electionDate) < startOfToday()) return null;
